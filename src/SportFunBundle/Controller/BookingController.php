...
use SportFunBundle\Form\BookingType;
...
class BookingController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SportFunBundle:Booking')->findAll();
     ...
     * @Method("POST")
     * @Template("SportFunBundle:Booking:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SportFunBundle:Booking')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SportFunBundle:Booking:edit.html.twig")
     */
